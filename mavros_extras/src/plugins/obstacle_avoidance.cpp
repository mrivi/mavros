...
private:
	...
	void obstacle_cb(const mavros_msgs::ObstacleAvoidance::ConstPtr &req)
	{
                ...
                obstacle_avoidance.point_1[0] = req->point_1.position_setpoint.x;
                obstacle_avoidance.point_1[1] = req->point_1.position_setpoint.y;
                obstacle_avoidance.point_1[2] = req->point_1.position_setpoint.z;
                obstacle_avoidance.point_1[3] = req->point_1.velocity_setpoint.x;
                obstacle_avoidance.point_1[4] = req->point_1.velocity_setpoint.y;
                obstacle_avoidance.point_1[5] = req->point_1.velocity_setpoint.z;
                obstacle_avoidance.point_1[6] = req->point_1.acceleration_setpoint.x;
                obstacle_avoidance.point_1[7] = req->point_1.acceleration_setpoint.y;
                obstacle_avoidance.point_1[8] = req->point_1.acceleration_setpoint.z;
                obstacle_avoidance.point_1[9] = req->point_1.yaw;
                obstacle_avoidance.point_1[10] = req->point_1.yaw_speed;

                obstacle_avoidance.point_2[0] = req->point_2.position_setpoint.x;
                obstacle_avoidance.point_2[1] = req->point_2.position_setpoint.y;
                obstacle_avoidance.point_2[2] = req->point_2.position_setpoint.z;
                obstacle_avoidance.point_2[3] = req->point_2.velocity_setpoint.x;
                obstacle_avoidance.point_2[4] = req->point_2.velocity_setpoint.y;
                obstacle_avoidance.point_2[5] = req->point_2.velocity_setpoint.z;
                obstacle_avoidance.point_2[6] = req->point_2.acceleration_setpoint.x;
                obstacle_avoidance.point_2[7] = req->point_2.acceleration_setpoint.y;
                obstacle_avoidance.point_2[8] = req->point_2.acceleration_setpoint.z;
                obstacle_avoidance.point_2[9] = req->point_2.yaw;
                obstacle_avoidance.point_2[10] = req->point_2.yaw_speed;

                obstacle_avoidance.point_3[0] = req->point_3.position_setpoint.x;
                obstacle_avoidance.point_3[1] = req->point_3.position_setpoint.y;
                obstacle_avoidance.point_3[2] = req->point_3.position_setpoint.z;
                obstacle_avoidance.point_3[3] = req->point_3.velocity_setpoint.x;
                obstacle_avoidance.point_3[4] = req->point_3.velocity_setpoint.y;
                obstacle_avoidance.point_3[5] = req->point_3.velocity_setpoint.z;
                obstacle_avoidance.point_3[6] = req->point_3.acceleration_setpoint.x;
                obstacle_avoidance.point_3[7] = req->point_3.acceleration_setpoint.y;
                obstacle_avoidance.point_3[8] = req->point_3.acceleration_setpoint.z;
                obstacle_avoidance.point_3[9] = req->point_3.yaw;
                obstacle_avoidance.point_3[10] = req->point_3.yaw_speed;

                obstacle_avoidance.point_4[0] = req->point_4.position_setpoint.x;
                obstacle_avoidance.point_4[1] = req->point_4.position_setpoint.y;
                obstacle_avoidance.point_4[2] = req->point_4.position_setpoint.z;
                obstacle_avoidance.point_4[3] = req->point_4.velocity_setpoint.x;
                obstacle_avoidance.point_4[4] = req->point_4.velocity_setpoint.y;
                obstacle_avoidance.point_4[5] = req->point_4.velocity_setpoint.z;
                obstacle_avoidance.point_4[6] = req->point_4.acceleration_setpoint.x;
                obstacle_avoidance.point_4[7] = req->point_4.acceleration_setpoint.y;
                obstacle_avoidance.point_4[8] = req->point_4.acceleration_setpoint.z;
                obstacle_avoidance.point_4[9] = req->point_4.yaw;
                obstacle_avoidance.point_4[10] = req->point_4.yaw_speed;

                obstacle_avoidance.point_5[0] = req->point_5.position_setpoint.x;
                obstacle_avoidance.point_5[1] = req->point_5.position_setpoint.y;
                obstacle_avoidance.point_5[2] = req->point_5.position_setpoint.z;
                obstacle_avoidance.point_5[3] = req->point_5.velocity_setpoint.x;
                obstacle_avoidance.point_5[4] = req->point_5.velocity_setpoint.y;
                obstacle_avoidance.point_5[5] = req->point_5.velocity_setpoint.z;
                obstacle_avoidance.point_5[6] = req->point_5.acceleration_setpoint.x;
                obstacle_avoidance.point_5[7] = req->point_5.acceleration_setpoint.y;
                obstacle_avoidance.point_5[8] = req->point_5.acceleration_setpoint.z;
                obstacle_avoidance.point_5[9] = req->point_5.yaw;
